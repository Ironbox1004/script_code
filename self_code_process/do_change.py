...
def class_filter(anno_list, class_map=None):
    ...
    sub_type_map = {
        ...
        'Special_Car': [
            '京东小车', '其他特种车', '大特种车', '工程车', '其他特种车', '小特种车', '无人骑行（停靠）', '三轮车'
        ],
        'Truck': [
            '货车',
        ],
...
def make_argParse():
    ...
    parser.add_argument('--dataset_path', default="/home/chenzhen/code/detection/datasets/dt_hangzhou/hangzhou/shijiao2", help="数据集的根目录")
    parser.add_argument('--folder_info', default="VOC_DT_20230221-2", help="xml中文件夹名，并以此为名为目录保存数据")
    ...
    parser.add_argument('--voc_save_path', default="/home/chenzhen/code/detection/datasets/dt_hangzhou", help="voc格式数据保存目录")
